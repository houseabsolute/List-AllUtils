...
https://metacpan.org/release/List-AllUtils

If you use cpanminus, you can do it without downloading the tarball first:

    $ cpanm --reinstall --installdeps --with-recommends List::AllUtils
...
You can also do this via cpanm directly:
    ...
    $ cpanm --reinstall --installdeps --with-develop --with-recommends List::AllUtils
...
The code for this distribution is [hosted at GitHub](https://github.com/autarch/List-AllUtils).
...
can submit an issue report [via the web](http://rt.cpan.org/Public/Dist/Display.html?Name=List-AllUtils)
